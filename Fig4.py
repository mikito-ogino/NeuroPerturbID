...
freqs = np.arange(5, 15, 0.05)  # 1 Hz to 20 Hz, 0.2 Hz steps
...
results_dir = "results"
os.makedirs(results_dir, exist_ok=True)
filename = f"{program_name}_A_matrix.pdf"
...
results_dir = "results"
os.makedirs(results_dir, exist_ok=True)
filename = f"{program_name}_freq_plot.pdf"
filepath = os.path.join(results_dir, filename)
plt.savefig(filepath, format="pdf")
plt.show()
...
plt.tight_layout()
filename = f"{program_name}_Qx_imshow.pdf"
filepath = os.path.join(results_dir, filename)
plt.savefig(filepath, format="pdf")
plt.show()
...
filename = f"{program_name}_ellipse_overlay_subplot.pdf"
filepath = os.path.join(results_dir, filename)
plt.savefig(filepath, format="pdf", bbox_inches='tight')  # Use bbox_inches='tight' to include all labels/titles
plt.show()
...
filename = f"{program_name}_ellipse_overlay_inv_subplot.pdf"
filepath = os.path.join(results_dir, filename)
plt.savefig(filepath, format="pdf")
plt.show()
# %%
